...
namespace ProjetoRefugiadosApi.Validations
{
    public class EnderecoValidation : AbstractValidator<Endereco>
    {
        public EnderecoValidation()
        {
            ...
            RuleFor(endereco => endereco.Estado).NotNull().WithMessage("Estado inválido.").Length(2).WithMessage("Estado deve conter entre 3 e 30 caracteres.");
            RuleFor(endereco => endereco.Rua).NotNull().WithMessage("Rua inválida.").Length(3, 100).WithMessage("Rua deve conter 2 caracteres.");
