...
window.addEventListener('load', function() {
  ...
  fetch(`http://localhost:5145/api/PostoDeSaude/Pages?pageNumber=0`,{
                headers: { 
        ...
        .then(post => {
            post.data.forEach(element => {
              ...
              <div class="card-body">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="29" fill="currentColor" class="bi bi-geo-alt" viewBox="0 0 16 16">
            ...
            for (let i = 0; i < post.totalPages; i++) {
              ...
              document.getElementById("pageNumbers").innerHTML += btnPageNumbers
            }            
